...
(() => {
  ...
  // Pekerjaan
  renderSummary('sumPekerjaan', dataDummy.pekerjaan.labels, dataDummy.pekerjaan.values, dummyTotal);
  makeBarHorizontal('chartPekerjaan', dataDummy.pekerjaan.labels, dataDummy.pekerjaan.values, colorsPekerjaan);
})
